    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.FileField(blank=True, upload_to='sponsor_logos/')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='solves', to='ctf.Flag')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='solves', to='ctf.Team')),
            ],
            options={
                'ordering': ('time',),
            },
